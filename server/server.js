...
app.use("/api/v1/diary", require("./routes/diaryRoutes"));
app.use("/api/v1/diymealkit", require("./routes/diyRoutes"));
app.use("/api/v1/redeem", require("./routes/redeemRoutes"));
app.use("/api/v1/logBreakfast", require("./routes/logFoodRoutes"));
app.use("/api/v1/logLunch", require("./routes/logFoodRoutes"));
app.use("/api/v1/logDinner", require("./routes/logFoodRoutes"));
app.use("/api/v1/allLogs", require("./routes/logFoodRoutes"));
