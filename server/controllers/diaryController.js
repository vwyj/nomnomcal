const diaryModel = require("../models/diaryModel");   // Import diaryModel which contains Mongoose for diary
...
const createDiaryController = async (req, res) => {   
    try                                             
    {
...
module.exports = { requireSignIn, createDiaryController };