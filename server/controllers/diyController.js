...
const rejectOrder = async (req, res) => {
  ...
  module.exports = { requireSignIn, createDiyMealController, bestsellingDiy, generateGraph, getAllDiyUser, mostPopDate, mostPopAge, popularAgeGroup, getAllPendingDiy, acceptOrder, rejectOrder }; 