...
const { createDiaryController } = require('../controllers/diaryController');
...
// Call createDiaryController function from postController to handle the creation of a post
router.post('/create-diary', requireSignIn, createDiaryController);
