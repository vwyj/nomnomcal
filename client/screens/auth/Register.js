...
const Register = ({ navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setLoading(false);
      const { CreateAccount } = await axios.post("http://ipaddress:5000/api/v1/auth/register", { name, email, password, dob: formattedDate , gender, height, weight, activitylvl, allergyString, question, answer, goal, totalCalories, address: {
        country, 
        unit,
        street,
        block,
